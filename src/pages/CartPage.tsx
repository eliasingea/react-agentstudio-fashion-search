...
function sendCheckoutEvent(items: CartItem[], totalPrice: number): Promise<void> {
...
export function CartPage() {
  ...
  const handleCheckout = async () => {
    await sendCheckoutEvent(items, totalPrice);
    clearCart();
    // Clear clicked items after checkout to prevent attribution errors
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            {items.map((item) => (
              ...
              >
                ...
                <Link
                  ...
                  className="w-32 h-32 bg-neutral-100 overflow-hidden"
                >
                  {item.primary_image && (
                    <img
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-neutral-200 p-8 sticky top-8">
              ...
              <button onClick={handleCheckout} className="w-full py-4 bg-black text-white text-sm tracking-widest hover:bg-neutral-800 transition-colors mb-4">
                CHECKOUT
              </button>
